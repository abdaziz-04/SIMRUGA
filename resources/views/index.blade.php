...
<body id="page-top" class="mt-4" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="54">
    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-dark navbar-dark" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top" style="font-family: 'Liberation Sans';">SIMRUGA</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto text-uppercase">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#map">LOKASI RW 8</a></li>
                    <li class="nav-item"><a class="nav-link" href="#contact">HUBUNGI PENGURUS RW</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <section id="services">
            <div class="container mt-0">
                ...
                <div class="col-lg-12 text-center" data-aos="zoom-in-up">
                    <h2 class="display-5 fw-bolder">Tentang SIMRUGA</h2>
                    <p style="line-height: 1.5; margin-bottom: 30px; font-size: 20px">
                        SIMRUGA / Sistem Informasi Rukun Warga merupakan pusat informasi bagi RW 8
                        yang digitalisasikan agar memungkinkan mempermudah mobilitas informasi, data,
                        dan proses adminitrasi warga.
                    </p>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    @foreach ($pengurus as $index => $member)
                        <div class="col-lg-3 col-md-4 col-sm-6 mb-0" data-aos="fade-down"
